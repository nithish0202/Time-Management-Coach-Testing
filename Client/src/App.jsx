...
import QuickTaskFormPage from './components/pages/QuickTaskFormPage';
...
// ];
 ...
 const allowedPatterns = [
  ...
  //     if (!toast.isActive('focus-mode-warning')) {
  //       toast.warn("Navigation disabled in Focus Mode", {
  ...
  return (
    <Routes>
      ...
      <Route path="/time-log" element={<QuickTaskFormPage />} />
...
function App() {
  ...
  <Button variant="outlined" style={{ marginLeft: 10 }}>
    View Focus Summary
        ...
        {/* Uncomment and use TaskManager here if needed */}
        {/* <TaskManager isFocusMode={isFocusMode} /> */}
